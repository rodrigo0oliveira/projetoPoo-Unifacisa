...
public class FuncionarioController {
	...
	public void  FuncionarioController(){
		...
		Object selecionado = JOptionPane.showInputDialog(null, 
				"Selecione", "Gerenciamento de funcionário", JOptionPane.INFORMATION_MESSAGE, null, opcoes, opcoes[0]);
	...
	private String verificarTurno() {
		...
		Object turnoEscolha = JOptionPane.showInputDialog(null, 
				"Selecione", "Gerenciamento de funcionário", JOptionPane.INFORMATION_MESSAGE, null, turnos, turnos[0]);
